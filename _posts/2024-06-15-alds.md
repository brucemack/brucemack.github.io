...
computer, an engineering team relies heavily on *the previous-generation* computer to enable their task. So-called Engineering Design Automation (EDA) tools are a way of life 
...
The primary EDA technology that both of these books are referencing is called the "Automated 
Logic Diagram" (ALD). It's a bit ironic that the elimination of paperwork is referenced in 
both of the quotes above, yet the only representation of the 1620 circuit we have left 
is in binders containing 400 nearly pages of paper ALD diagrams!
...
misses the innovations that enabled the 1620 design. I used many of the tools 
