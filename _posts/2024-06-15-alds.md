...
Where things get interesting from a software simulation standpoint is in the section of the _System Diagram_ books that contains the complete ALD of the referenced machine. Here's an example of an ALD page:
...
* The total page is 120x186 characters.This an aspect ratio was chosen to fit on 11x17 inch "B" 
size ledger paper. 
...
The 716 printer supported a line width of 120 characters using 120 printing wheels, each with 48 available
characters. This is consistent with the fact that the 705 used a 6-bit character representation. 

One of the differences between the 716 and the 717 (perhaps the only difference?) was the 
substitution of a special diagraming print wheel. The 717 wheel contained 48 characters: the 26 upper-case letters, 
...
top right corner, bottom left corner, bottom right corner, cross, and diamond). This finally explains the 
use of the odd "bottom right corner" character in many of the 1620 page names and signal names seen in the ALDs.  
For example, 
...
using a less sophisticated print wheel since the wiring looks like more traditional ASCII art.
...
The print wheel used in the 1620 ALD apparently extended the box drawing elements to the extremes of the character impression area to allow lines to link continuously. Not bad for a re-purposed accounting machine!
...
After reading about the history of EDA at IBM, I am very confident that the development teamw working at the 
