...
less important now given the diversity of navigation systems in orbit. However, the reliability issue is more accute now than it was in 2007 given the
...
conference. Only one receiver is selected by the voter at a time. However, the audio streams from 
...
that the ~150 bytes of "implementation defined" payload in the PING message (payload type 5) provided
