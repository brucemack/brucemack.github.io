...
hubs, direct audio connection, etc.). 
...
for a broad set of telephony applications. As such, it can be hard to configure and hard to enhance. The Ampersand project is 
...
Ampersand enables integration with the AllStarLink network, 
abbreviated as ASL. For the purposes of this description, 
...
* The AllStarLink registration service that provides:
  ...
  APIs.
* The AllStarLink monitoring service to provides:
